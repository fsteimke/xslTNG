...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'monograph')]">
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      ...
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'medium')]"/>
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'secondary')]"/>
      ...
      <xsl:sequence select="db:date[fp:contains-token(@role, 'cit')]"/>
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'serie')]"/>
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'serial')]">
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      <xsl:sequence select="db:title"/>
      <xsl:sequence select="db:subtitle"/>
      ...
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'secondary')]"/>
      <xsl:sequence select="db:edition"/>
      <xsl:sequence select="db:pubdate[fp:contains-token(@role, 'issuing')]"/>
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'part')]">
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      <xsl:sequence select="db:authorgroup|db:author"/>
      <xsl:sequence select="db:title"/>
      ...
      <xsl:sequence select="db:pubdate"/>
      <xsl:sequence select="db:date[fp:contains-token(@role, 'cit')]"/>
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'secnum')]"/>
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'sectitle')]"/>
      <xsl:sequence select="db:pagenums"/>
      <xsl:sequence select="db:biblioid"/>
    </db:biblioentry>
  </xsl:variable>
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'contribution')]">
  ...
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      ...
      <db:biblioset relation="book">
        ...
        <xsl:sequence select="$book/db:bibliomisc[fp:contains-token(@role, 'medium')]"/>
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'article')]">
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'patent')]">
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      <xsl:sequence select="db:authorgroup|db:author"/>
      <xsl:sequence select="db:title"/>
      ...
      <xsl:sequence select="db:bibliomisc[fp:contains-token(@role, 'patenttype')]"/>
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'messagesystem')]">
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      <xsl:sequence select="db:title"/>
      <xsl:sequence select="db:subtitle"/>
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'message')]">
  <xsl:variable name="part" select="db:biblioset[@relation='part']"/>
  <xsl:variable name="book" select="db:biblioset[@relation='book']"/>
  ...
  <xsl:variable name="entry">
    <db:biblioentry role="{@role}">
      ...
      <db:biblioset relation="book">
        ...
        <xsl:sequence select="$book/db:publisher"/>
        <xsl:sequence select="$book/db:pubdate"/>
        <xsl:sequence select="$book/db:date[fp:contains-token(@role, 'cit')]"/>
        <xsl:sequence select="$book/db:biblioid"/>
      </db:biblioset>
    </db:biblioentry>
  </xsl:variable>
...
<xsl:template match="db:title" mode="mp:biblio690-punct">
  <xsl:choose>
    <xsl:when test="following-sibling::db:bibliomisc[fp:contains-token(@role, 'medium')]">
      <!-- nop -->
    </xsl:when>
...
<xsl:template match="db:bibliomisc[fp:contains-token(@role, 'secondary')]">
  <span>
    <xsl:apply-templates select="." mode="m:attributes"/>
    <xsl:apply-templates/>
  </span>
  ...
  <xsl:choose>
    <xsl:when test="$fs/self::db:bibliomisc and fp:contains-token($fs/@role, 'secondary')">
...
<xsl:template match="db:bibliomisc[fp:contains-token(@role, 'serie')]">
  <span>
    <xsl:apply-templates select="." mode="m:attributes"/>
    <xsl:apply-templates/>
  </span>
...
<xsl:template match="db:bibliomisc[fp:contains-token(@role, 'patenttype')]">
  <span>
    <xsl:apply-templates select="." mode="m:attributes"/>
    <xsl:apply-templates/>
  </span>
...
<xsl:template match="db:bibliomisc[fp:contains-token(@role, 'medium')]">
...
<xsl:template match="db:issuenum">
  ...
  <xsl:choose>
    <xsl:when test="following-sibling::*[1]/self::db:date[fp:contains-token(@role, 'cit')]">
      <!-- nop -->
    </xsl:when>
...
<xsl:template match="db:date[fp:contains-token(@role, 'cit')]">
...
<xsl:template match="db:biblioid[fp:contains-token(@class, 'uri')]">
  <span>
    <xsl:apply-templates select="." mode="m:attributes"/>
    <xsl:choose>
      <xsl:when test="preceding-sibling::db:biblioid[fp:contains-token(@class, 'uri')]">
...
<xsl:template match="db:biblioid">
  ...
  <xsl:sequence select="if (fp:contains-token(@otherclass, 'patentnum'))
...
<xsl:template match="db:biblioentry[fp:contains-token(@role, 'patent')]/db:address">
